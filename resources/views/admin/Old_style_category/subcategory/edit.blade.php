...
<!-- Modal -->
<div class="modal fade" id="subcategoryModalEdit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <form id="subcategoryEditForm" enctype="multipart/form-data" >
            ...
            <div class="modal-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-12 mb-2">
                      <label for="subcategory_image2" class="form-label">subcategory Image</label>
                      <input type="file" class="form-control" id="subcategory_image2" name="subcategory_image" >
                    </div>
...
<script>
    document.getElementById('subcategory_image2').addEventListener('change', function (event) {
