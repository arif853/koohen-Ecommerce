...
<head>
    ...
    <!-- Fav Icon  -->
    <link rel="shortcut icon" href="{{asset('admin/assets/imgs/theme/favicon.ico')}}">
    <!-- Page Title  -->
    <title>Koohen | Invoice Print</title>
    <!-- StyleSheets  -->
    <link rel="stylesheet" href="{{asset('admin/assets/css/dashlite.css?ver=3.2.2')}}">
    <link id="skin-default" rel="stylesheet" href="{{asset('admin/assets/css/theme.css?ver=3.2.2')}}">
</head>
