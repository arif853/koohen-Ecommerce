            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$key+1}}</td>
                        <td>{{$item->feature_products_title}} </td>
                        <td>
                            <img src="{{asset('storage/'.$item->image)}}" alt="{{$item->feature_products_title}}" width="70" >
                        </td>
                        {{-- <td>{{$item->text}}</td> --}}
                        ...
                        <td class="text-end">
                            ...
                            <form class="deleteForm" action="{{route('category_feature.destroy', ['id' => $item->id])}}" method="post">
                                ...
                                <a href="#"  class="btn btn-sm font-sm rounded btn-brand edit-item"
                                    data-bs-toggle="modal" data-bs-target="#FproductModalEdit" data-item-id="{{ $item->id}}">
      ...
      <div class="modal-content">
        ...
        <form enctype="multipart/form-data" id="fetureForm">
            ...
            <div class="modal-body">
                <input type="hidden" name="product_feature_id" id="product_feature_id" >
                <div class="row g-3">
                    <div class="col-md-12 mb-2">
                        <label for="title" class="form-label">Feature title<span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="feature_products_title" name="feature_products_title" placeholder="Feature title" required>
                    </div>
                    <div class="col-md-12 mb-2">
      ...
      <div class="modal-content">
        ...
        <form action="{{route('product_feature.store')}}" method="POST" enctype="multipart/form-data" >
            ...
            <div class="modal-body">
                ...
                <div class="row g-3">
                    <div class="col-md-12 mb-2">
                        <label for="title" class="form-label">Feature Products title<span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="title" name="feature_products_title" placeholder="Feature title" required>
                    </div>
                    <div class="col-md-12 mb-2">
                        <label for="products_id" class="form-label"> Products <span class="text-danger">*</span></label>
                        <select id="products_id" class="form-control select-nice" multiple  name="products_id[]">
                            <option value="">--Select product--</option>
                            @foreach ($products as $product)
                              <option value="{{ $product->id}}">{{ $product->product_name }}</option>
                    ...
                    <div class="col-md-12 mb-2">
                      <label for="image" class="form-label">Feature Image<span class="text-danger">*</span></label>
