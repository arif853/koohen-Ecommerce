                            ...
                            <ul class="d-lg-flex">
                                <li class="mega-menu-col col-lg-6">
                                    <ul>
                                        ...
                                        <li><a class="dropdown-item nav-link nav_item" href="#">Blouses & Shirts</a>
                                        </li>
                            ...
                            <ul class="d-lg-flex">
                                <li class="mega-menu-col col-lg-6">
                                    <ul>
                                        ...
                                        <li><a class="dropdown-item nav-link nav_item" href="#">Faux Leather Coats</a>
                                        </li>
                                        ...
                                        <li><a class="dropdown-item nav-link nav_item" href="#">Vests & Waistcoats</a>
                                        </li>
                                ...
                                <li class="mega-menu-col col-lg-6">
                                    <ul>
                                        ...
                                        <li><a class="dropdown-item nav-link nav_item" href="#">Tailor-made Suits</a>
                                        </li>
                                        <li><a class="dropdown-item nav-link nav_item" href="#">Cover-Ups</a></li>
                                    </ul>
                                </li>
                            ...
                            <ul class="d-lg-flex">
                                <li class="mega-menu-col col-lg-6">
                                    <ul>
                                        ...
                                        <li><a class="dropdown-item nav-link nav_item" href="#">Refurbished Phones</a>
                                        </li>
                                        <li><a class="dropdown-item nav-link nav_item" href="#">Mobile Phone</a></li>
                                        <li><a class="dropdown-item nav-link nav_item" href="#">Mobile Phone Parts</a>
                                        </li>
                                        <li><a class="dropdown-item nav-link nav_item" href="#">Phone Bags & Cases</a>
                                        </li>
                                ...
                                <li class="mega-menu-col col-lg-6">
                                    <ul>
                                        ...
                                        <li><a class="dropdown-item nav-link nav_item" href="#">Screen Protectors</a>
                                        </li>
                                        <li><a class="dropdown-item nav-link nav_item" href="#">Wire Chargers</a></li>
                                        <li><a class="dropdown-item nav-link nav_item" href="#">Wireless Chargers</a>
                                        </li>
