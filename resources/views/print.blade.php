        ...
        <div class="invoice_wrapper">
            <div class="header">
                <div class="logo_invoice_wrap">
                    <div class="logo_sec">
                        <img src="{{ URL::to('frontend/assets/imgs/Kohen_Logo_Main.png') }}" alt="code logo"><br>
                    ...
                    <div class="invoice_sec">
                        <p class="invoice bold" style="background-color:#e6e6e6;color:#528d52 ;padding-right:6px;">
                            INVOICE</p>
                    ...
                    <div class="bill_sec">
                        ...
                        <ul style="width: 100%;margin-top:5%;">
                            <li style="margin-bottom:2%;">Name <span style="font-weight: 600; margin-left:40px;">
                                    {{ $data->customer->firstName . ' ' . $data->customer->lastName }} </span> </li>
                            <li style="margin-bottom:2%;">Phone <span style="margin-left:40px;">
                                    {{ $data->customer->phone }}</span>
                            </li>
                            <li style="margin-bottom:2%;">Address<span
                                    style="margin-left:36px;">{{ $data->customer->billing_address }}</span></li>
            ...
            <div class="body">
                    ...
                    <div class="container">
                        <div class="row" style="padding:3%;margin: 0 auto;">
                            <table style="width:100%; text-align: center;">
                                ...
                                <tbody>
                                    @foreach ($data->order_item as $key => $item)
                                        <tr>
                ...
                <div class="paymethod_grandtotal_wrap">
                    ...
                    <div class="grandtotal_sec" style="padding-right:3%;font-size:12px; width:40%;">
                        <p class=""
                            style="display: flex; flex-wrap: wrap; padding-top: 2px;background:  #99ddff;margin-right:5px; ">
                            <span style="padding-top:7px;">Sub total</span>
                            <span> <input value=" {{ $data->subtotal }}"
                        ...
                        <p style="background: #e6e6e6; ">
                            ...
                            <span><input value="{{ $data->delivery_charge }} "
            ...
            <div class="footer">
                <div class="terms">
                    <p class="tc bold" style="font-size: 13px; margin-bottom:5px;">নিন্মোক্ত শর্ত সাপেক্ষে কোন ধরনের
